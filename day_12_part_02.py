...
class Node:
    ...
    def visitable(self):
        ...
        if not self.visited:
            ...
            return Node.twice_visited_small_node == None
    ...
    def visit(self):
        ...
        if not self.visited:
            ...
            # visiting this node for the second time
            assert Node.twice_visited_small_node == None
            Node.twice_visited_small_node = self

    def unvisit(self):
        if self.is_large:
            return

        if self.visited and (Node.twice_visited_small_node == self):
            Node.twice_visited_small_node = None
        else:
            self.visited = False
